...
All property listings, prices and company figures are **fictional demo content** for a fictional developer. The headline statistics (12 years, 450,000 m², 1,200 families, 35 complexes) are carried over from the user's own reference board. No metric is invented beyond that board and no real company is represented.
