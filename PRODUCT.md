...
- **Zillow / generic listing portal.** Dense tables, utilitarian chrome, ad clutter, listings-as-spreadsheet.
- **Crypto/SaaS glassmorphism.** Purple-blue neon gradients, glowing cards, "Elevate your portfolio." Glass here is daylight and frost, never neon.
- **Luxury real-estate cliché.** Gold serif wordmarks, marble, script fonts, "Bespoke Living," old-money pastiche.
...
WCAG 2.1 AA. Body text ≥4.5:1, large text ≥3:1 — enforced specifically over glass and photographic backdrops, where this design language most often fails. Every animation has a `prefers-reduced-motion: reduce` alternative. Full keyboard navigation with visible focus rings; modal focus trap and Escape to close. No information conveyed by color alone.
